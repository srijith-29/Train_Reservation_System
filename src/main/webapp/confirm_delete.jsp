...
<body>
    <div class="container">
        ...
        <p>The schedule and associated reservations have been deleted.</p>

        <!-- Display deleted schedule details -->
        <h3>Deleted Schedule Details</h3>
        ...
        <div class="responsive-table">
            ...
            %>
                <p class="no-impact">No reservations were impacted by this deletion.</p>
            <% } else { %>
                <table>
                    <thead>
                        <tr>
