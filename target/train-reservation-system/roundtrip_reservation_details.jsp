...
<html>
<head>
    <title>Round Trip Reservation Details</title>
    ...
    <script>
        ...
        function updateFare() {
            const outboundFare = parseFloat(document.getElementById("outboundFare").value);
            const returnFare = parseFloat(document.getElementById("returnFare").value);
...
<body>
    <div class="fare-summary">
        <p><strong>Outbound Fare:</strong> $<%= request.getParameter("outboundFare") %></p>
        <p><strong>Return Fare:</strong> $<%= request.getParameter("returnFare") %></p>
    ...
    <div class="reservation-container form-container">
        ...
        <form id="passengerForm" action="completeRoundTripReservation" method="POST" onsubmit="serializePassengerData()">
            ...
            <input type="hidden" name="returnDepartureDate" id="returnDepartureDate" value="<%= request.getParameter("returnDepartureDate") %>">
            <input type="hidden" name="outboundFare" id="outboundFare" value="<%= request.getParameter("outboundFare") %>">
            <input type="hidden" name="returnFare" id="returnFare" value="<%= request.getParameter("returnFare") %>">
